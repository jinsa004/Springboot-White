...
//데이터 받기 연습
//GET -> http body가 없음. QueryString, PathVariable(PK) -> Form(GET) -> 브라우저(주소 뒤 ? 붙이기)
...
public class SecondController {
	...
	//QuerySting = x-www-form-urlencoded 타입이다.
	@GetMapping("/second")
	public String getData2(String title, String content) {
		return "title : "+title+", content : "+content;
	}
	
	//BR -> title=제목&content=내용, 헤더의 컨텐트타입정보 x-www-form-urlencoded를 보고 파씽할 수 있게 됨.
	@PostMapping("/second")
